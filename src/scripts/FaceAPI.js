...
const FaceAPI = {
    resolveSkinType: function (id) {
        switch (id) {
            case 0: return 'oily skin'
            case 1: return 'dry skin'
            case 2: return 'normal skin'
            case 3: return 'mixed skin'
            default: return 'oily skin,dry skin,normal skin,mixed skin'
        }
    },
